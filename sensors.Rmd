...
7.  Plug the modem in and please ensure that it is powered on.

8.  The sensor will record automatically; you do not need to do anything except ensure that it and the modem remain plugged in for the duration of the study. If the sensor or modem is accidently unplugged, then please try to plug it in as soon as you can to avoid data loss.
